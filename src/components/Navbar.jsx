...
const Navbar = () => {
  const mainPages = ["products", "about"];
  ...
  return (
    <AppBar
      position="sticky"
      sx={{ width: "100%", fontSize: "1.2rem", padding: ".3rem" }}
    >
      {matches ? (
        <AppBarContainer>
          <IconButton
        ...
        <AppBarContainer maxWidth="xl">
          ...
          <Box>
            ...
            <Link to={user.email !== null ? "/cart" : "/login"} aria-label="Go to my Cart">
              <Button sx={{ color: "white" }}>
                <ShoppingCart />{" "}
                <Typography
                  sx={{ marginTop: "-1rem" }}
